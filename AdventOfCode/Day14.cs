...
namespace AdventOfCode
{
    public static class Day14
    {
        ...
        /// </summary>
        private static readonly Regex _maskPattern = new Regex(@"^mask = ([X10]+)$", RegexOptions.Compiled);

        /// <summary>
        /// Regular expression to match a memory allocation.
        /// </summary>
        private static readonly Regex _memoryAllocationPatthern = new Regex(@"^mem\[(\d+)\] = (\d+)$", RegexOptions.Compiled);
